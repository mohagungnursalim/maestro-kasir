        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">     
            ...
            <form wire:submit.prevent="updateSettings" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model="store_address" class="w-full border-gray-300 border rounded-md p-2" required>
                ...
                <div>
                    ...
                    <input type="text" wire:model="store_phone" class="w-full border-gray-300 border rounded-md p-2" required>
                    @error('store_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
            
                <!-- Tampilan Logo yang Ada -->
                @if ($store_logo)
                    <img src="{{ asset($store_logo) }}" alt="Logo" class="h-24 p-2 border-2 border-gray-400 border-dashed rounded-lg">
                @endif
