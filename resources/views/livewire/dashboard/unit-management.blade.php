    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div wire:init='loadInitialUnits' class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            ...
                            @php
                                $skeletonCount = $totalUnits > 0 ? min($totalUnits, $limit) : 1;
                            @endphp
                            @for ($i = 0; $i < $skeletonCount; $i++) <tr class="bg-white border-b">
                                ...
                                <tr class="bg-white border-b hover:bg-gray-300 text-gray-900">
                                    ...
                                    <td class="px-6 py-4">
                                        <div>
                                            <button wire:click="editModal({{ $unit->id }})"
                                        ...
                                        <div>
                                            <button wire:click="deleteConfirmation({{ $unit->id }})"
                                ...
                                @empty
                                <tr>
                                    <td colspan="2" class="text-center align-middle h-20">
                ...
                {{-- Tombol Load More --}}
                @if($units->count() >= $limit && $totalUnits > $limit)
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                ...
                <form wire:submit.prevent="store">
                    <div class="grid mb-4" style="max-height: 60vh; overflow-y: auto;">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nama Satuan</label>
