...
<div class="h-full px-3 pb-4 overflow-y-auto bg-white">
    <ul class="space-y-2 font-medium">
        ...
        <li>
            <a wire:navigate href="/dashboard/transactions"
                class="flex items-center p-2 rounded-lg {{ Request::is('dashboard/transactions') ? 'bg-purple-300 text-dark' : 'hover:bg-gray-200' }} group">
        ...
        <li>
            ...
            <ul 
                ...
                <a wire:navigate href="/dashboard/suppliers"
                    class="flex items-center p-2 rounded-lg {{ Request::is('dashboard/suppliers') ? 'bg-purple-300 text-dark' : 'hover:bg-gray-200' }} group">
                    <i class="bi bi-arrow-return-right"></i>
